...
import 'package:news_watch/presentation/main/tabBar/health/health_viewModel.dart';
...
class _HealthTabState extends State<HealthTab> {
  ...
  void initState()  {
    initHealthModule();
    _viewModel = instance<HealthViewModel>();
   _call();
    super.initState();
  }
  ...
  _gridData() {
    return StreamBuilder<List<ArticleData>>(
        stream: _viewModel.outputHealthDetails,
        builder: (context, snapshot) {
  ...
  Widget _scienceList(List<ArticleData>? data) {
    String screenTitle = AppStrings.health;
