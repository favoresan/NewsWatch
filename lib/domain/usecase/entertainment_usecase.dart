...
class EntertainmentUseCase implements BaseUseCase<void, Article> {
  Repository _repository;
  EntertainmentUseCase(this._repository);

  @override
  Future<Either<Failure, Article>> execute(void input) async {
    return await _repository.getEntertainmentArticle();
  }

  Future<Either<Failure, Article>> executeIn(void input) async {
    return await _repository.getEntertainmentRefreshArticle();
  }
}
